...
$(document).ready(function () {
  ...
  function getCreditFor(fileName) {
    if (fileName !== "") {
      ...
      for (let creditEntry of parsedCredits) {
        ...
        if (fileName.startsWith(creditPath) && creditPath.length > prospectPath.length && !creditEntry.startsWith(creditPath + ",,,,")) {
  ...
  function triggerCompact() {
    const compactTogglers = $("[data-compact]");
    const toggleCheck = $("#displayMode-compact");
